    ...
    <div>
      <div className="py-24 sm:py-32">
        ...
        <div className="max-w-md mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 md:max-w-2xl gap-8 lg:max-w-4xl">
          ...
          <div className="ring-1 ring-gray-200 p-8 h-fit pb-12 rounded-3xl">
            ...
            >
              <li className="flex gap-x-3">
                <CheckIcon className="h-6 w-5 flex-none text-orange-600" />2
                Documents
              </li>
              <li className="flex gap-x-3">
                <CheckIcon className="h-6 w-5 flex-none text-orange-600" />
                Up to 15 messages per document
              </li>
              <li className="flex gap-x-3">
                <CheckIcon className="h-6 w-5 flex-none text-orange-600" />
          ...
          {/* PRO */}
          <div className="ring-2 ring-orange-600 rounded-3xl p-8">
            <h3 className="text-lg font-semibold leading-8 text-orange-600">
              Pro Plan
            </h3>
            <p className="mt-4 text-sm leading-6 text-gray-600">
            ...
            <Button
              className="bg-orange-600 w-full text-white shadow-sm hover:bg-orange-500 mt-6 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600"
